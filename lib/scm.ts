...
import { normalizeLeadtimeGap, normalizeStockoutKpi, normalizeStockoutRisk, type DemandProfile, type ForecastModel, type ForecastRun, type ForecastSettings, type LeadtimeGap, type StockoutKpi, type StockoutRisk } from './scm-model';
